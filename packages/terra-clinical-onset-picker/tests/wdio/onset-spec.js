  ...
  describe('Onset Picker', () => {
    ...
    describe('when unknown precision selected', () => {
      before(() => {
        ...
        browser.click('[id=test-precision-select]');
        browser.click('[id=terra-select-option-unknown]');
      });
    ...
    describe('Displays year selection only when Year granularity selected', () => {
      before(() => {
        browser.url('/#/raw/tests/terra-clinical-onset-picker/clinical-onset-picker/default');
        browser.click('[id=test-granularity-select]');
        browser.click('[id=terra-select-option-year]');
      });
    ...
    describe('Can select a year between the birthdate and current year', () => {
      before(() => {
        ...
        browser.click('[id=test-year-select]');
        browser.click('[id=terra-select-option-2015]');
      });
    ...
    describe('Cannot select a year before the birthdate', () => {
      ...
      browser.click('[id=test-year-select]');
      browser.click('[id=terra-select-option-2010]');
      Terra.should.matchScreenshot();
      Terra.should.beAccessible({ rules });
    });
    ...
    describe('Cannot select a year in the future', () => {
      ...
      browser.click('[id=test-year-select]');
      browser.click('[id=terra-select-option-2017]');
      Terra.should.matchScreenshot();
      Terra.should.beAccessible({ rules });
    });
    ...
    describe('Displays month and year selection only when Month-Year granularity selected', () => {
      before(() => {
        browser.url('/#/raw/tests/terra-clinical-onset-picker/clinical-onset-picker/default');
        browser.click('[id=test-granularity-select]');
        browser.click('[id=terra-select-option-month]');
      });
    ...
    describe('Can select a month between the birthdate and current date', () => {
      before(() => {
        ...
        browser.click('[id=test-month-select]');
        browser.click('[id=terra-select-option-3]');
      });
    ...
    describe('Cannot select a month before the birthdate', () => {
      before(() => {
        ...
        browser.click('[id=test-year-select]');
        browser.click('[id=terra-select-option-2011]');
      });

      browser.click('[id=test-month-select]');
      browser.click('[id=terra-select-option-1]');
      Terra.should.matchScreenshot();
      Terra.should.beAccessible({ rules });
    });
    ...
    describe('Cannot select a month in the future', () => {
      before(() => {
        ...
        browser.click('[id=test-year-select]');
        browser.click('[id=terra-select-option-2016]');
      });

      browser.click('[id=test-month-select]');
      browser.click('[id=terra-select-option-9]');
      Terra.should.matchScreenshot();
      Terra.should.beAccessible({ rules });
    });
    ...
    describe('Displays date input when Date granularity is selected', () => {
      before(() => {
        browser.url('/#/raw/tests/terra-clinical-onset-picker/clinical-onset-picker/default');
        browser.click('[id=test-granularity-select]');
        browser.click('[id=terra-select-option-date]');
      });
    ...
    describe('Displays age inputs when Age granularity is selected', () => {
      before(() => {
        browser.url('/#/raw/tests/terra-clinical-onset-picker/clinical-onset-picker/default');
        browser.click('[id=test-granularity-select]');
        browser.click('[id=terra-select-option-age]');
      });
    ...
    describe('Cannot select number of years greater than age', () => {
      before(() => {
        ...
        browser.click('[id=test-age-unit-select]');
        browser.click('[id=terra-select-option-years]');

        browser.clearElement('[id=test-age-input]');
        browser.setValue('[id=test-age-input]', 10);
    ...
    describe('Cannot select more than 24 months', () => {
      before(() => {
        ...
        browser.click('[id=test-age-unit-select]');
        browser.click('[id=terra-select-option-months]');

        browser.clearElement('[id=test-age-input]');
        browser.setValue('[id=test-age-input]', 30);
        browser.click('button[type="submit"]');
        browser.pause(2900);
      });
    ...
    describe('Cannot select number of months that exceede age', () => {
      before(() => {
        ...
        browser.clearElement('[id=test-age-input]');
        browser.setValue('[id=test-age-input]', 20);
        browser.click('button[type="submit"]');
        browser.pause(2900);
      });
    ...
    describe('Cannot select more than 8 weeks', () => {
      before(() => {
        ...
        browser.click('[id=test-age-unit-select]');
        browser.click('[id=terra-select-option-weeks]');

        browser.clearElement('[id=test-age-input]');
        browser.setValue('[id=test-age-input]', 15);
        browser.click('button[type="submit"]');
        browser.pause(2900);
      });
    ...
    describe('Cannot select number of weeks that exceede age', () => {
      before(() => {
        ...
        browser.clearElement('[id=test-age-input]');
        browser.setValue('[id=test-age-input]', 6);
        browser.click('button[type="submit"]');
        browser.pause(2900);
      });
    ...
    describe('When onsetDate is changed by the age input an event is fired to the onsetDateInputOnChange callback', () => {
      before(() => {
        ...
        browser.clearElement('[id=test-age-input]');
        browser.setValue('[id=test-age-input]', 4);
        browser.click('button[type="submit"]');
      });
